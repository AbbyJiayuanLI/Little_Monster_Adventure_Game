...
void ElePipe::init()
{
    ...
    this->pipeRect[above].setRect(576 + this->startPosition*175.6,  -271.0 + qrand()%200,   42.0,   321.0);
    this->pipeRect[following].setRect(576 + this->startPosition*175.6,  this->pipeRect[above].bottom() + 100.0,     42.0,   321.0);
//    this->speedX = 2.5;
}
...
{
    this->clearAllFrame();
    this->addFrame(QPixmap(":sea/pipe_down.png"));
    this->addFrame(QPixmap(":sea/pipe_up.png"));
}
